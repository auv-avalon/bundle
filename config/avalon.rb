...
Syskit.conf.use_deployment 'stucture', :on => 'front'
...
Syskit.conf.use_deployment 'tritech_modem'
Syskit.conf.use_deployment 'blueview'
#Syskit.conf.use_deployment 'modem_position'
...
Syskit.conf.use_deployment 'sonar_structure_servoing'
