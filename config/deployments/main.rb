...
define('localization', Cmp::DualLocalization.use('sonar').use(Cmp::UwvModel))
define('navigation', Cmp::Navigation.use(Cmp::DualLocalization.use('sonar').use(Cmp::UwvModel)))
