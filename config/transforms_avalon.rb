...
dynamic_transform "orientation_in_map.orientation_in_map", "body" => "map_sauce"
#dynamic_transform "orientation_estimator.attitude_b_g", "body" => "map_halle"

dynamic_transform "uw_particle_localization.pose_samples", "body" => "map_sauce"
dynamic_transform "pose_estimator.pose_samples", "body" => "map_sauce"
