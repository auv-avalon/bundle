...
data_service_type 'Motion2DController', :provides => ActuatorController do
    input_port('command', 'base/MotionCommand2D').
        doc('input command in rotation and translation.')
end

data_service_type 'Motion2DCommand', :provides => Command do
...
# such as GPS
data_service_type 'GlobalPose', :provides => Pose
...
data_service_type 'RelativePose', :provides => Pose
...
data_service_type 'CompensatedIMUSensors', :provides => IMUSensors
data_service_type 'CalibratedIMUSensors', :provides => IMUSensors
